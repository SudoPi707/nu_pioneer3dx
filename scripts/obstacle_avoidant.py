...
class ObstacleAvoidant:
    ...
    def __init__(self):
        ...
        self.obs_force_scale = 5  # The larger, the more distance from robot to obstacle
        self.global_percent = 0.7
    ...
    def compute(self, vector, laser, robot, goal):
        ...
        self.obs_force_scale = goal_magnitude  # TO MAKE ROBOT STOP
        ...
        # print(summed_magnitude, summed_yaw)

        return summed_magnitude, goal_magnitude, summed_yaw
